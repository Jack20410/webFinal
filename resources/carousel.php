<div class="container-fluid">
    ...
    <div id="carouselRide" class="carousel slide container-fluid " data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            <img src="../assets/images/Carousel/carousel2.jpg" width="800" height="600" class="d-block w-100" alt="carou2">
            </div>

            <div class="carousel-item" data-bs-interval="3000">
            <img src="../assets/images/Carousel/doraemon.jpg" width="800" height="600" class="d-block w-100" alt="carou3">
            </div>
        </div>
